...
export const Searcher = ({searchQuery}) => {
  const { state: { spotifyToken}, debouncedChangeHandler } = useContext(GlobalContext);
  ...
  return (
    ...
    <div className={styles.Searcher}>
      ...
      <input value={searchQuery} placeholder="Artists, songs or albums" maxLength="80" type="text" onChange={debouncedChangeHandler}/>
    </div>
    }
    </>
  )
